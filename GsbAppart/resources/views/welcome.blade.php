...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="max-w-xl w-full bg-white p-8 rounded-lg shadow-md">
        ...
        <p class="text-gray-600 mb-6">Nous sommes ravis de vous accueillir sur notre site TOURE LOC! Connectez-vous ou inscrivez-vous dès maintenant pour profiter de toutes nos fonctionnalités.</p>
